        ...
        <div>
            ...
            <div className="location-grid">
                <div className="info-card" style={{ borderColor: COLORS.SKY }}>
                    ...
                    <p><strong>Dirección:</strong> Ex Gobernación de Los Andes. Av. 9 de Julio s/n, San Antonio de los Cobres, Salta.</p>
                ...
                <div className="info-card" style={{ borderColor: COLORS.OCRE }}>
                    ...
                    <ul className="directions-list">
                        <li>
                            ...
                            <div>
                                <strong>Por Ruta 51 (Vehículo Particular):</strong> Distancia 160 km. Tiempo estimado: 3 a 4 horas.
                            </div>
                        </li>
                    </ul>
                </div>
